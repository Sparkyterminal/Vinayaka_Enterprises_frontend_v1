            ...
            >
              ...
              <div className="flex-1">
                <p className="text-base text-gray-700 leading-relaxed">
                  ...
                  meticulous planning, innovative design, and flawless
                  execution.
                </p>
              </div>
            </motion.div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
              ...
              >
                <p className="text-xs text-gray-600">
                  © 2025 Vinayaka Enterprises. All rights reserved.
                </p>
              </motion.div>
              ...
              >
                <p className="text-xs text-gray-600">
                  ...
                  <motion.a
                    ...
                    className="font-semibold text-[#1D3271] hover:text-[#1e3f9f] transition-colors duration-300"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                  >
                    Navi InfoTech
