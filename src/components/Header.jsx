        ...
        <div className="px-6 mx-auto sm:px-8 lg:px-12 max-w-7xl">
          <div className="flex items-center justify-between">
            ...
            <motion.button
              ...
              className="flex items-center shrink-0 text-2xl lg:text-3xl font-bold hover:opacity-80 transition-opacity duration-200 focus:outline-none cursor-pointer"
              aria-label="Home"
            ...
            <nav className="hidden md:flex md:items-center md:space-x-6 lg:space-x-8 xl:space-x-10">
              {menuItems.map(({ label, id }, index) => (
                <motion.button
                  ...
                  className={`relative text-base font-medium hover:text-blue-600 transition-all duration-200 focus:outline-none group cursor-pointer ${
